...
public class LinkedListDeque61BTest {
     ...
     @Test
    /** This test checks whether the deque is empty. */
    public void isEmptyAndSizeTest() {
     ...
     @Test
    /** This test checks get functionality. */
    public void getTest() {
         Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
         assertThat(lld1.get(2345)).isNull();

         lld1.addLast(2);
         assertThat(lld1.get(0)).isEqualTo(2);

         lld1.addLast(50);
         assertThat(lld1.get(1)).isEqualTo(50);

         assertThat(lld1.get(-2345)).isNull();
     }

     @Test
     /** This test check getRecursive functionality. */
    public void getRecursiveTest() {
         Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
         assertThat(lld1.getRecursive(2345)).isNull();

         lld1.addLast(2);
         assertThat(lld1.getRecursive(0)).isEqualTo(2);

         lld1.addLast(50);
         assertThat(lld1.getRecursive(1)).isEqualTo(50);

         assertThat(lld1.getRecursive(-2345)).isNull();
     }

     @Test
    /** This test checks removeFirst and removeLast functionality. */
